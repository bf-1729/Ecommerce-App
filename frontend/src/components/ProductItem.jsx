...
const ProductItem = ({ id, image, name, company, price }) => {
  ...
  return (
    <Link className='text-gray-700 cursor-pointer lg:px-0.5 px-1' to={`/products/${id}`}>

      <div className="rounded-lg">
        <div className='overflow-hidden'>
          <img src={image[0]} className='hover:scale-110 transition ease-in-out sm:w-[230px] w-[237px] h-[260px] lg:h-[280px] object-cover' alt=''>
          </img>
        </div>
