...
const WomensWear = () => {
  const { WomensProducts, search, showSearch, products } = useContext(ShopContext);
  ...
  const applyFilter = () => {
    let productsCopy = [...WomensProducts];
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-4">
        ...
        <div className="flex-1">
          <div className="flex justify-between text-base sm:text-2xl mb-2 lg:pr-0 pr-1">
            <Title text1={"WOMENS"} text2={"COLLECTION"} />
          ...
          <div className="border-b pb-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-2 px-0 w-full">
            {filterProducts.length ? (filterProducts.slice(start, end).map((item, index) => (
              ...
              : (<div className="flex items-center justify-center text-black font-extrabold h-[300px] lg:w-[900px] w-screen"><h1 className="lg:text-2xl text-lg">No Items Found</h1></div>)}
          </div>
